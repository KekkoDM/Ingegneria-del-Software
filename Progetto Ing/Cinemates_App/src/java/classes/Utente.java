...
public class Utente implements Serializable {
                ...
                try {
                    ...
                    if (!obj.getBoolean("error")) {
                        ...
                        for (int i = 0; i < sharedItems.length(); i++) {
                            ...
                            requestJson.parseJSONSavedList(resultsActivity.getRecyclerView(), media);
                        }
                    } else {
    ...
    public void addToList(Media media, String list, Context context) {
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    if (!obj.getBoolean("error")) {
                        ...
                        params.putString("media_title", media.getTitle());
    ...
    public void removeFromList(Media media, String list, Context context) {
